...
// found on file: CPtestMG5_py6_30gev_yb2.root
//////////////////////////////////////////////////////////
...
#ifdef CPtestMG5_cxx
CPtestMG5::CPtestMG5(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {

     //     TChain * chain = new TChain("t1","CPtestMG5_H.root");
     //     chain->Add("CPtestMG5_H.root");

     /*
     TChain * chain = new TChain("t1","CPtestMG5_A.root");
     chain->Add("CPtestMG5_A.root");
     */

     TChain * chain = new TChain("t1","CPtestMG5_CPmix.root");
     chain->Add("CPtestMG5_CPmix.root");

     //     TChain * chain = new TChain("t1","CPtestMG5_H_LO.root");
     //     chain->Add("CPtestMG5_H_LO.root");
...
Int_t CPtestMG5::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CPtestMG5::LoadTree(Long64_t entry)
{
...
void CPtestMG5::Init(TTree *tree)
{
...
void CPtestMG5::Show(Long64_t entry)
{
...
Int_t CPtestMG5::Cut(Long64_t entry)
{
