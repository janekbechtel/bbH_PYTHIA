...
void Draw()
{
  ...
  leg->SetFillColor(10);
  leg->AddEntry(hptb1,"POWHEG+PY8","L");
  ...
  hptb1->SetLineWidth(3);
  hptb1->Draw("samehist");
  leg->AddEntry(hptb1,"MG5_aMC@NLO+PY8 ","L");
  leg->Draw();
  //  Latex
  ...
  c1->SaveAs("ptb1_mA700_MGvsPWHG.pdf"); 
  ...
  TLegend *leg = new TLegend(0.50,0.65,0.90,0.75,NULL,"brNDC");
  leg->SetFillColor(10);
  leg->AddEntry(hptb2,"POWHEG+PY8","L");
  TFile* file = new TFile("bbh_tautau_700gev_mg5_hist.root");
  ...
  hptb2->SetLineWidth(3);
  hptb2->Draw("samehist");
  leg->AddEntry(hptb2,"MG5_aMC@NLO+PY8 ","L");
  leg->Draw();
  //  Latex
  TLatex *tex = new TLatex(0.15,0.96,"#bf{CMS}");
  tex->SetNDC();
  ...
  c2->SaveAs("ptb2_mA700_MGvsPWHG.pdf"); 
  ...
  TLegend *leg = new TLegend(0.50,0.65,0.90,0.75,NULL,"brNDC");
  leg->SetFillColor(10);
  leg->AddEntry(hptj,"POWHEG+PY8","L");
  TFile* file = new TFile("bbh_tautau_700gev_mg5_hist.root");
  ...
  hptj->SetLineWidth(3);
  hptj->Draw("samehist");
  leg->AddEntry(hptj,"MG5_aMC@NLO+PY8","L");
  leg->Draw();
  //  Latex
  TLatex *tex = new TLatex(0.15,0.96,"#bf{CMS}");
  tex->SetNDC();
  ...
  TLatex *t = new TLatex();
  t->SetTextSize(0.05);
  t->DrawLatex(40.0,0.09,"gg#rightarrowbbA, m_{A}=700 GeV");
  c3->SaveAs("ptj_mA700_MGvsPWHG.pdf"); 
}
