...
class bbz_mumu : public edm::EDAnalyzer {
public:
  explicit bbz_mumu(const edm::ParameterSet&);
  ~bbz_mumu();
...
void 
//bbz_mumu::beginJob(const edm::EventSetup&)
bbz_mumu::beginJob()
{
  using namespace edm;
...
//
bbz_mumu::bbz_mumu(const edm::ParameterSet& iConfig)
...
void
bbz_mumu::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
  //
  pth22    = 0.; 
