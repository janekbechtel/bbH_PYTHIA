...
void Draw()
{
  ...
  TFile* file = new TFile("ptz40_60.root");
  ...
  hptj_div_ptz_barrel->SetMaximum(0.035);
...
//  Latex
  ...
  TLatex *t = new TLatex();
  t->SetTextSize(0.05);
  t->DrawLatex(0.4,0.032,"Z(#mu#mu) + #geq 1 jet, p_{T}^{j}>25 GeV, |#eta|<4.7");
  t->SetTextSize(0.04);
  t->DrawLatex(0.15,0.029,"#bullet HLT_IsoMu24 or HLT_IsoTkMu24");
  t->DrawLatex(0.15,0.026,"#bullet p_{T}^{#mu1,2}>25, 20 GeV, |#eta^{#mu}|<2.1, 80<m_{#mu#mu}<100 GeV");
  t->DrawLatex(0.15,0.023,"#bullet 40<p_{T}^{Z}<60 GeV, #Delta#phi(Z-j1)>2.6, p_{T}^{miss}<40 GeV");
  t->SetTextSize(0.04);
  t->DrawLatex(0.9,0.019,"JEC Summer16_23Sep2016V4");
  t->DrawLatex(1.35,0.007,"j1 - leading p_{T} jet");
  c1->SaveAs("ZplusJet_13TeV_ptz40_60.pdf"); 
}
