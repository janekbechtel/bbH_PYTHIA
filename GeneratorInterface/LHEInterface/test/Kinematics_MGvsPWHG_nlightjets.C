...
void Draw()
{
  ...
  leg->SetFillColor(10);
  leg->AddEntry(hnlj,"POWHEG+PY8","L");
  ...
  hnlj->SetLineWidth(3);
  hnlj->Draw("samehist");
  leg->AddEntry(hnlj,"MG5_aMC@NLO+PY8","L");
  leg->Draw();
  //  Latex
  ...
  TLatex *t = new TLatex();
  t->SetTextSize(0.05);
  t->DrawLatex(0.5,0.45,"gg#rightarrowbbA, m_{A}=700 GeV; #geq 1 b-jet selection");
  c1->SaveAs("nlj_mA700_MGvsPWHG.pdf"); 
}
