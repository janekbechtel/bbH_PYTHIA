...
void Draw()
{
  ...
  //
  leg->AddEntry(hpth62,"MG5_aMC@NLO, ","L");
  leg->Draw();
  ...
  TLatex *t = new TLatex();
  t->SetTextSize(0.05);
  t->DrawLatex(150.0,0.4,"gg#rightarrowbbA, m_{A}=700 GeV");
  c1->SaveAs("bbA_ptA700GeV.pdf"); 
  ...
  c2->SaveAs("bbA_ptA700GeV_mg5.pdf"); 
}
