...
// found on file: mumuj_py6_30gev_yb2.root
//////////////////////////////////////////////////////////
...
#ifdef mumuj_cxx
mumuj::mumuj(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {

     TChain * chain = new TChain("t1","mumuj_mg5_amcnlo.root");
     chain->Add("mumuj_mg5_amcnlo.root");
...
Int_t mumuj::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mumuj::LoadTree(Long64_t entry)
{
...
void mumuj::Show(Long64_t entry)
{
...
Int_t mumuj::Cut(Long64_t entry)
{
